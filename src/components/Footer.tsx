...
export default function Footers(){
    ...
    return <div className={`flex  items-center justify-around w-full select-none ${theme != "light"? "bg-bgds": "bg-white"} `}>
    <div className={`flex flex-col lg:flex-row w-full justify-between ${theme != "light"? "text-white border-forHover":"text-bgds border-red-300"} bg-transparent backdrop-blur-sm  px-10 py-6  h-auto lg:mx-56 my-7 border-[0.1px] rounded-lg `}>
