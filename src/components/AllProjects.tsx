  ...
  return (
    <div className={`${mode != "light"? "bg-bgds text-white": "bg-white text-bgds"} font-chill py-44 px-[5%] `}>
        ...
        {/* <div className="flex justify-center mt-10">
            <Link to="/projects"><button className={` px-5 py-3 font-chill font-semibold rounded-md uppercase transition-all ease-in-out duration-500 ${mode != "light"? "bg-white text-bgds hover:bg-forHover hover:text-white":"bg-bgds text-white hover:bg-red-300 hover"}`} >More Projects</button></Link>
        </div> */}
    </div>
  )
}
